...
public class AdminBizImpl implements AdminBiz {
    ...
    @Override
    public ReturnT<String> callback(List callbackParamList) {
        for (Object object: callbackParamList) {
            HandleCallbackParam handleCallbackParam = (HandleCallbackParam) object;
